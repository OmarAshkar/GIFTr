...
#' @description This data is a manipulated copy of \link{GIFTr} data with removal of the multiple answers mcq and removal of asterisk from the single answer mcq.
#' @docType data
...
#'   \item{\code{question_type}}{character question type value should be either `mcq`, `num_q`, `tf_q`, `short_ans` }
#'}
#' @details This data is an altered form of \link{GIFTr}. Check it usage in \link{mcq}. For further details on the data structure, check \link{GIFTr} documentation.
